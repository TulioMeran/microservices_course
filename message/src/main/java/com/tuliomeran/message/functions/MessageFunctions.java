package com.tuliomeran.message.functions;

import com.tuliomeran.message.dto.AccountMsgDto;
...
public class MessageFunctions {
    ...
    public Function<AccountMsgDto, AccountMsgDto> email(){
        return accountMsgDto -> {
            log.info("Sending email with the details: "+accountMsgDto.email().toString());
            return accountMsgDto;
        };
    }
    @Bean
